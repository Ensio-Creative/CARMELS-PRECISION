<template>
  <div>
    ...
    <div class="lg:w-2/3 mx-auto text-center my-12 p-4">
      ...
      <div>
        <textarea class="border-b border-[#C3C3C3] w-full p-2 h-32 my-2" placeholder="Message"></textarea>
      </div>
      <div>
        <input type="button" class="w-full bg-[#0E1E43] text-white p-3 my-2" value="SEND MESSAGE">
      </div>
    </div>
  </div>
</template>
